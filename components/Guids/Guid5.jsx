...
const Guid5 = ({setOrder}) => {
    return (
        ...
        className=' w-screen h-screen flex flex-col items-center'>
            ...
            <Image src={"/images/home5.svg"} width={100} height={100} className='w-4/5 h-40 ' />
            <button  className='w-3/5  mt-12 text-xl bg-primary-1 py-3 flex justify-center items-center rounded-3xl font-semibold' >Pharmacy</button>
