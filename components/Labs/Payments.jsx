    ...
    return (
        <div className='w-full h-full  pt-8 px-6'>
            <div className='w-full flex'>
                <Image src={"/images/taleb.svg"} width={1000} height={1000} className='w-1/3 h-20' />
                <div className='ms-4'>
            ...
            <div className='w-full flex justify-between px-4 mt-4 '>
                ...
                <span className='text-sm '>1500.00 DA</span>
            </div>
            ...
            <div className='w-full flex justify-between px-4 mt-2 '>
                ...
                <span className='text-sm text-primary-1'>1700.00 DA</span>
            </div>
            <div className='w-11/12 border-t border-gray-200  mx-6 my-4 '></div>
                ...
                popUp ?
                    <Popup closePopup={(e) => { }}>
                        <div className='w-4/5 h-3/5 px-4 bg-white rounded-xl flex flex-col items-center'>
                            ...
                            <p className='text-sm mt-4 text-center'>Your payment has been successful, you can have a consultation session with your trusted doctor</p>
