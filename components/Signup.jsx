...
const Signup = () => {
    ...
    return (
        <div className='relative w-screen h-screen flex flex-col items-center pt-8'>
            ...
            <button className='w-4/5 mt-6 bg-primary-1 py-3 flex justify-center rounded-full font-semibold text-white' >Sign Up</button>
