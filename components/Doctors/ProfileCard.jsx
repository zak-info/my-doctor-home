...
const ProfileCard = () => {
    return (
        <div className='w-11/12 h-32 bg-white  rounded-2xl flex items-center '>
            <Image src={"/images/p1.svg"} width={100} height={100} className="w-24 h-24 rounded-lg " />
            <div className='h-5/6 pt-3 ms-4'>
                ...
                <div className='w-12 flex mt-4  items-center bg-secondry-1 px-1 rounded'>
